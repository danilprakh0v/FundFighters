...
Назначение: Экран приветствия с пошаговым руководством для новых пользователей.
===============================================================================
...
final class EntryAnimationViewController: UIViewController {
    ...
    // Свечение над иллюстрацией (на всю длину, 20% opacity)
    ...
    // Свечение под иллюстрацией (на всю длину, 10% opacity)
    ...
    private func navigateToLogin() {
        // Сохраняем флаг прохождения онбординга
        UserDefaults.standard.set(true, forKey: "hasSeenOnboarding")
        let loginVC = LoginViewController()
        
        // Плавная анимация перехода к экрану логина
